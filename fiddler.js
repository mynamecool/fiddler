...
class Handlers
{
    ...
    */
    ...
    public static RulesOption("请求日语内容(&J)")
    var m_Japanese: boolean = false;

    // Automatic Authentication
    public static RulesOption("自动验证(&A)")
    ...
    RulesStringValue(25,"自定义(&C)...", "%CUSTOM%")
    public static var sUA: String = null;

    // Cause Fiddler to delay HTTP traffic to simulate typical 56k modem conditions
    public static RulesOption("模拟调制解调器速度(&M)", "性能(&F)")
    var m_SimulateModem: boolean = false;

    // Removes HTTP-caching related headers and specifies "no-cache" on requests and responses
    public static RulesOption("禁用缓存(&D)", "性能(&F)")
    var m_DisableCaching: boolean = false;

    public static RulesOption("始终保持最新(&F)", "性能(&F)")
    ...
    public static ContextAction("解码所选会话")
...
*/
    ...
    */
    ...
    static function Main() {
        ...
        FiddlerObject.StatusText = " CustomRules.js 被装载在: " + today;
